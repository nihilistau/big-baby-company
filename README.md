...
`v1.0.9` · Browser · Single-player · ~60–90 minutes per run · Zero runtime dependencies
...
```
10,674 lines of JavaScript · 168 tests · 54 art assets · 4,804 lines of content JSON
```
...
```bash
npm test                            # 168 tests: sim, content integrity, fuzz, UI
